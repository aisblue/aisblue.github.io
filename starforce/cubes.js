...
cube.rates.main = {
    ...
    weapon: {
        ...
        legendary: {
            ...
            o2: {
                t1: [0.104651, 0.093023],
                t2: [0.083721, 0.074419],
                t3: [0.062791, 0.055814],
                t4: [0.009756, 0.019512],
                t5: [0.007317, 0.014634],
                t6: [0.004878, 0.009756]
            },
            o3: {
                t1: [0.115, 0.110465],
                t2: [0.092, 0.088372],
                t3: [0.069, 0.066279],
                t4: [0.000976, 0.004878],
                t5: [0.000732, 0.003659],
                t6: [0.000488, 0.002439]
            }
        }
    }
};
...
cube.cube = function(type, dom, cb, o) {
    ...
    if (!["red", "black", "mcc", "meister", "equality"].includes(type)) {
        cube_type = "bonus";
...
cube.stats = {
    ...
    */
    main: function(e, r, c, f = "main", l, o) {
        ...
        let rates_map = []; //probability map
        if(c == "equality")
            rates_map = cube.rates[c][e][r];
        else
            rates_map = cube.rates[f][e][r];
        let stats_map = [];
        if(c == "equality")
            stats_map = cube.pot_stats[c][e][r]; //stat map
        else
            stats_map = cube.pot_stats[f][e][r]; //stat map
